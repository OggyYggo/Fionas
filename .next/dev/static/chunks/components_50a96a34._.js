    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ToursSection.useEffect": ()=>{
            ...
            const observer = new IntersectionObserver({
                "ToursSection.useEffect": (entries)=>{
                    entries.forEach({
                        "ToursSection.useEffect": (entry)=>{
            ...
            revealElements.forEach({
                "ToursSection.useEffect": (el)=>observer.observe(el)
            }["ToursSection.useEffect"]);
            return ({
                "ToursSection.useEffect": ()=>{
                    revealElements.forEach({
                        "ToursSection.useEffect": (el)=>observer.unobserve(el)
                    }["ToursSection.useEffect"]);
                }
            })["ToursSection.useEffect"];
        }
...
//# sourceMappingURL=components_50a96a34._.js.map